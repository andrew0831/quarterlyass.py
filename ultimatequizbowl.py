...
cursor.executemany('''INSERT INTO ENGL (question, option_a, option_b, option_c, option_d, answer) 
...
cursor.executemany('''INSERT INTO DBMGMT (question, option_a, option_b, option_c, option_d, correct answer 
...
cursor.executemany('''INSERT INTO BMGT (question, option_a, option_b, option_c, option_d, correct answer 
                      VALUES(?, ?, ?, ?, ?, ?)''', bmgt_quizbowl_questions)

cursor = conn.cursor()

cursor.execute(''' CREATE TABLE IF NOT EXIST ECON(
               id INTEGER PRIMARY KEY AUTOINCRIMENT,
               question TEXT NOT NULL,
               option_a TEXT NOT NULL,
               option_b TEXT NOT NULL,
...
cursor.executemany('''INSERT INTO ECON (question, option_a, option_b, option_c, option_d, correct answer 
                VALUES(?, ?, ?, ?, ?, ?)''', econ_quizbowl_questions)

cursor = conn.cursor()

cursor.execute(''' CREATE TABLE IF NOT EXIST DS(
               id INTEGER PRIMARY KEY AUTOINCRIMENT,
               question TEXT NOT NULL,
               option_a TEXT NOT NULL,
               option_b TEXT NOT NULL,
...
cursor.executemany('''INSERT INTO DS (question, option_a, option_b, option_c, option_d, correct answer 
